...
// Please Wait Method
  void plaesewaitmassagedevicedata(
    ...
    QuickAlert.show(
      ...
      title: "Please Wait",
      text:
          "Your process is currently running on the device data..+' '+$rowCounter",
    );
  }
        ...
        return ValueListenableBuilder<int>(
          ...
          builder: (context, count, child) {
            return AlertDialog(
              ...
              content: Text('Processing row number: $count'),
            );
          },
        );
      },
  ...
  Future<void> retrieveStoredData(BuildContext context, String deviceid) async {
    ...
    try {
      ...
      //  plaesewaitmassagedevicedata(context, rowCounter);
      ...
      if (dataFile != '') {
        ...
        await for (List<int>? value in desiredCharacteristic.value) {
          ...
          if (value != null) {
            ...
            if (isInsideRow) {
              if (newData.trim().endsWith('#')) {
                isInsideRow = false;
                print('Data row number : -$rowCounter');
              }
            }
